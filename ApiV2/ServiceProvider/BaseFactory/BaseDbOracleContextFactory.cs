...
{
    public class BaseDbOracleContextFactory : IBaseDbContextFactory
    {
        private readonly IConfiguration _config;
        private string key = "12313231trfssdadad@hSDaaaa321313";

        public BaseDbOracleContextFactory(IConfiguration config)
        {
            _config = config;
        }
        ...
        private String GetConnectionString()
        {
            ...
            if (ConfigConnectionString != null)
            {
                ...
                return "Data Source=(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = IPHOST)(PORT = PORT))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = SERVICENAME)));User Id=USERNAME; Password=PASSWORD;";
        }
