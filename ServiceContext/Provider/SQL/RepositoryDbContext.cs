...
namespace ServiceContext.Provider.SQL
{
    public class RepositoryDbContext : BaseDbContext
    {
        ...
        public RepositoryDbContext(string connstring, IConfiguration config) : base(connstring)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(_connString, opts => opts.CommandTimeout((int)TimeSpan.FromMinutes(timeout).TotalSeconds));
        }
